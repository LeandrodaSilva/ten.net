        ...
        <div className="mx-auto mt-12 max-w-md space-y-8 sm:mt-16 lg:hidden">
          {tiers.map((tier) => (
            ...
            >
              ...
              <ul
                role="list"
                className="mt-10 space-y-4 text-sm/6 text-gray-900 dark:text-gray-200"
              >
              ...
              <thead>
                <tr>
                  ...
                  {tiers.map((tier) => (
                    ...
                    >
                      <div className="text-sm/7 font-semibold text-gray-900 dark:text-white">
                        {tier.name}
                      </div>
                    </th>
                  ))}
                  ...
                  <Fragment key={section.name}>
                    ...
                    {section.features.map((feature) => (
                      <tr key={feature.name}>
                        <th
                          scope="row"
                          className="py-4 text-sm/6 font-normal text-gray-900 dark:text-gray-200"
                        >
                          {feature.name}
