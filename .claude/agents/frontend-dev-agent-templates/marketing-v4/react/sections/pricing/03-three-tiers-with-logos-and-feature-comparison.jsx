              ...
              >
                <div className="grid grid-cols-1 rounded-4xl p-2 shadow-md shadow-black/5 dark:shadow-none">
                  <div className="rounded-3xl bg-white p-10 pb-9 shadow-2xl ring-1 ring-black/5 dark:bg-gray-800 dark:shadow-none dark:ring-white/10">
                    ...
                    <p className="mt-2 text-sm/6 text-pretty text-gray-600 dark:text-gray-300">
                      {tier.description}
                    </p>
            ...
            <tbody key={section.name} className="group">
              ...
              {section.features.map((feature) => (
                ...
                >
                  <th
                    scope="row"
                    className="px-0 py-4 text-sm/6 font-normal text-gray-600 dark:text-gray-300"
                  >
                    {feature.name}
                  </th>
                  {tiers.map((tier) => (
                  ...
                  <Fragment key={section.name}>
                    ...
                    <dl>
                      {section.features.map((feature) => (
                        ...
                        >
                          <dt className="text-sm/6 font-normal text-gray-600 dark:text-gray-300">
                            {feature.name}
                          </dt>
