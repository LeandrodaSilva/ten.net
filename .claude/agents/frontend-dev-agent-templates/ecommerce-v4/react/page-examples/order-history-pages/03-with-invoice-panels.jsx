    ...
    products: [
      {
        ...
        price: "$70.00",
        imageSrc:
          "https://tailwindcss.com/plus-assets/img/ecommerce-images/order-history-page-03-product-01.jpg",
        imageAlt:
      ...
      },
      {
        ...
        price: "$90.00",
        imageSrc:
          "https://tailwindcss.com/plus-assets/img/ecommerce-images/order-history-page-03-product-02.jpg",
        imageAlt:
          "Bright yellow canvas tote with double-stitched straps, handle, and matching zipper.",
      },
    ],
  },
  {
    ...
    products: [
      {
        ...
        price: "$40.00",
        imageSrc:
          "https://tailwindcss.com/plus-assets/img/ecommerce-images/order-history-page-03-product-03.jpg",
        imageAlt:
          "Garment bag with two layers of grey and tan zipper pouches for folded shirts and pants.",
      },
    ],
  },
];
                ...
                <div className="flex h-14 space-x-8 overflow-x-auto border-t border-gray-200 px-4 pb-px sm:h-full sm:justify-center sm:overflow-visible sm:border-t-0 sm:pb-0">
                  {navigation.categories.map((category) => (
                    <Popover key={category.name} className="flex">
                      ...
                      <PopoverPanel
                        transition
                        className="group absolute inset-x-0 top-full z-20 w-full bg-white text-gray-500 transition data-closed:opacity-0 data-enter:duration-200 data-enter:ease-out data-leave:duration-150 data-leave:ease-in sm:text-sm"
                      >
                        ...
                        <div
                          aria-hidden="true"
                          className="absolute inset-0 top-0 z-10 mx-auto h-px sm:max-w-7xl sm:px-6 lg:px-8"
                        >
