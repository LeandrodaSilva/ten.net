                    ...
                    <div className="flex h-full space-x-8">
                      {navigation.categories.map((category, categoryIdx) => (
                        <Popover key={category.name} className="flex">
                          ...
                          <PopoverPanel
                            transition
                            className="group absolute inset-x-0 top-full z-20 w-full -translate-y-px bg-white text-sm text-gray-500 transition data-closed:opacity-0 data-enter:duration-200 data-enter:ease-out data-leave:duration-150 data-leave:ease-in"
                          >
