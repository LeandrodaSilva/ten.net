        ...
        >
          ...
          <dl className="flex w-full flex-none justify-between gap-x-8 sm:w-auto">
              ...
              {discussion.commenters.map((commenter) => (
                <dd key={commenter.id}>
                  <img
                    ...
                    className="size-6 rounded-full bg-gray-50 outline-2 outline-white dark:bg-gray-800 dark:outline-gray-900"
                  />
                </dd>
              ))}
            </div>
            <div className="flex w-16 gap-x-2.5">
              ...
              <dd className="text-sm/6 text-gray-900 dark:text-white">
