...
export type PluginModel = Record<string, "string" | "number" | "boolean" | "object">;
...
export abstract class Plugin {
	...
	private async _index(_req: Request, ctx: any): Promise<Response> {
		return new Response(
			JSON.stringify({
				plugin: this.name,
	...
	private _addIndexRoute() {
		...
		route.method = "GET";
		route.call = this._index.bind(this);
