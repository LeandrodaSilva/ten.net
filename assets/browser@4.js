...
(() => {
    ...
    for (let i = 0; i < t.length; i++) {
      ...
      if (13 !== g || (l = t.charCodeAt(i + 1), l !== e)) {
        if (92 === g) "" === p && (m = i), p += t.slice(i, i + 2), i += 1;
          ...
          if (
            (32 === g || g === e || 9 === g) && (l = t.charCodeAt(i + 1)) &&
            (32 === l || l === e || 9 === l ||
            ...
            for (let n = i + 2; n < t.length; n++) {
              if (l = t.charCodeAt(n), 92 === l) n += 1;
                ...
                if (40 === l) e += ")";
                  ...
                  (41 === l || 93 === l || 125 === l) && e.length > 0 &&
                    t[n] === e[e.length - 1] && (e = e.slice(0, -1));
                }
              }
            }
            let u = n(p, c);
    ...
    for (let i = r + 1; i < t.length; i++) {
      if (o = t.charCodeAt(i), 92 === o) i += 1;
        ...
        if (
          ...
          throw new Error(
            `Unterminated string: ${
              t.slice(r, i + 1) + String.fromCharCode(n)
            }`,
          );
        }
  ...
  function i(e) {
    ...
    for (; ++o < n;) {
      t = r.charCodeAt(o),
        i += 0 !== t
          ? t >= 1 && t <= 31 || 127 === t || 0 === o && t >= 48 && t <= 57 ||
              1 === o && t >= 48 && t <= 57 && 45 === a
            ? "\\" + t.toString(16) + " "
            : t >= 128 || 45 === t || 95 === t || t >= 48 && t <= 57 ||
  ...
  var l = new Map([["--font", ["--font-weight", "--font-size"]], ["--inset", [
    "--inset-shadow",
    "--inset-ring",
  ]], ["--text", [
    "--text-color",
  ...
  function v(e) {
    ...
    return h(g(e), (e) => {
      if ("function" === e.kind && "var" === e.value) {
        return h(e.nodes, (e) => {
          "word" !== e.kind || "-" !== e.value[0] || "-" !== e.value[1] ||
            t.push(e.value);
        }),
          1;
      }
  ...
  function T(e, t, r = 3) {
    ...
    function p(e, u, h = {}, m = 0) {
      if ("declaration" === e.kind) {
        if (
          "--tw-sort" === e.property || void 0 === e.value || null === e.value
        ) return;
        ...
        "@keyframes" === e.name && h.theme && l.add(t),
          (t.nodes.length > 0 || "@layer" === t.name || "@charset" === t.name ||
            "@custom-media" === t.name || "@namespace" === t.name ||
            "@import" === t.name) && u.push(t);
            ...
            h(o, (e, { replaceWith: r }) => {
              ...
              if (
                h(e.nodes, (e, { replaceWith: r }) => {
                  if (
                    "word" == e.kind && "currentcolor" === e.value.toLowerCase()
                  ) return o = !0, void (i = !0);
                ...
                let t = e.nodes[2];
                "word" === t.kind &&
                  ("oklab" === t.value || "oklch" === t.value ||
                    "lab" === t.value || "lch" === t.value) &&
                  (t.value = "srgb");
              }
            }), !i
          ) continue;
        ...
        for (let i = 0; i < e.length; i++) {
          ...
          if (
            ...
            if (41 === a) t += e[i], r.shift();
              ...
              if (
                32 === a && r[0] && 32 === t.charCodeAt(t.length - 1)
              ) continue;
    ...
    for (let t of e) {
      switch (t.kind) {
        case "function":
          ...
          if (
            "var" === t.value || t.value.endsWith("_var") ||
            "theme" === t.value || t.value.endsWith("_theme")
          ) {
            t.value = W(t.value);
      ...
      if (e.value) {
        if ("arbitrary" === e.value.kind) {
          let n = X(e.value.value),
            ...
            [i, a] = n ? ["(", ")"] : ["[", "]"];
          t += `${r ? "-" : ""}${i}${Z(o)}${a}`;
        } else {"named" === e.value.kind &&
            (t += `${r ? "-" : ""}${e.value.value}`);}
      }
    }
    return "compound" === e.kind && (t += e.root, t += "-", t += P(e.variant)),
    ...
    return h(t, (e, { parent: n }) => {
      ...
      if (
        ...
        "separator" === e.kind && "/" === e.value.trim()
          ? e.value = "/"
          : "separator" === e.kind && e.value.length > 0 &&
              "" === e.value.trim()
  ...
  var Y = new u((e) => {
    let t = g(e);
    return 3 === t.length && "word" === t[0].kind && "&" === t[0].value &&
        "separator" === t[1].kind && ":" === t[1].value &&
        "function" === t[2].kind && "is" === t[2].value
      ? m(t[2].nodes)
      : e;
  });
  function G(e) {
  ...
  var oe = {
    ...
    position: function (e) {
      ...
      for (let r of L(e, " ")) {
        if (
          "center" !== r && "top" !== r && "right" !== r && "bottom" !== r &&
          "left" !== r
        ) {
          if (!r.startsWith("var(")) {
            if (ve(r) || he(r)) {
    ...
    "line-width": function (e) {
      return L(e, " ").every(
        (e) =>
          ve(e) || fe(e) || "thin" === e || "medium" === e || "thick" === e,
      );
    },
    image: function (e) {
      let t = 0;
    ...
    "generic-name": function (e) {
      return "serif" === e || "sans-serif" === e || "monospace" === e ||
        "cursive" === e || "fantasy" === e || "system-ui" === e ||
        "ui-serif" === e || "ui-sans-serif" === e || "ui-monospace" === e ||
        "ui-rounded" === e || "math" === e || "emoji" === e || "fangsong" === e;
    },
    "absolute-size": function (e) {
      return "xx-small" === e || "x-small" === e || "small" === e ||
        "medium" === e || "large" === e || "x-large" === e ||
        "xx-large" === e || "xxx-large" === e;
    },
    ...
    for (let n of t.nodes) {
      ...
      if (
        ...
        if ("named" === e.kind && "word" === n.kind) {
          if (!_e.includes(n.value)) continue;
        ...
        if (
          "arbitrary" === e.kind && "word" === n.kind && "[" === n.value[0] &&
  ...
  function Be(e, t, r, n, o = "") {
    let i = !1,
      ...
      ).map((e) => `drop-shadow(${e})`).join(" ");
    return i
      ? [
        x(e, o + L(t, ",").map((e) => `drop-shadow(${je(e, n)})`).join(" ")),
  ...
  var Le = {
    ...
    "--theme": function (e, t, r, ...n) {
      ...
      if (
        i.startsWith("var(") || i.startsWith("theme(") ||
        i.startsWith("--theme(")
      ) {
        let e = g(i);
        return function (e, t) {
  ...
  function Re(e, t) {
    ...
    return C(e, (e) => {
      if ("declaration" === e.kind && e.value && Ie.test(e.value)) {
        return r |= 8, void (e.value = qe(e.value, e, t));
      }
      "at-rule" === e.kind &&
        ("@media" === e.name || "@custom-media" === e.name ||
          "@container" === e.name || "@supports" === e.name) &&
        Ie.test(e.params) && (r |= 8, e.params = qe(e.params, e, t));
    }),
      r;
  }
  function qe(e, t, r) {
  ...
  function Ze(e) {
    let t = new u(
      (e) => ({ name: e, utility: e, fraction: !1, modifiers: [] }),
    );
  ...
  var Ye = /^@?[a-z0-9][a-zA-Z0-9_-]*(?<![_-])$/,
    Ge = class {
      ...
      compoundsWith(e, t) {
        ...
        return !!(r && n && "compound" === r.kind && 0 !== n.compounds &&
          0 !== r.compoundsWith && r.compoundsWith & n.compounds);
      }
      suggest(e, t) {
        this.completions.set(e, t);
      }
      ...
      compare(e, t) {
        ...
        if ("compound" === e.kind && "compound" === t.kind) {
          ...
          return 0 !== r
            ...
            ? e.modifier.value < t.modifier.value ? -1 : 1
            : e.modifier
            ? 1
            : t.modifier
            ? -1
  ...
  function Je(e) {
    ...
    for (let r of e) {
      if ("@" !== r[0]) {
        ...
        if (
          !r.startsWith("@media") && !r.startsWith("@supports") &&
  ...
  function et(e) {
    let t = function (e) {
        ...
        function o(n, o) {
          ...
          o.supportsNegative && t.functional(`-${n}`, i({ negative: !0 })),
            ...
            r(n, () => [{
              ...
              hasDefaultValue: void 0 !== o.defaultValue &&
                null !== o.defaultValue,
        ...
        n("box-border", [["box-sizing", "border-box"]]),
          ...
          n("line-clamp-none", [["overflow", "visible"], ["display", "block"], [
            "-webkit-box-orient",
            "horizontal",
        ...
        n("size-auto", [["--tw-sort", "size"], ["width", "auto"], [
          "height",
          "auto",
        ]]),
          n("w-auto", [["width", "auto"]]),
        ...
        for (let e of ["x", "y", "both"]) {
          n(`snap-${e}`, [p, [
            "scroll-snap-type",
            `${e} var(--tw-scroll-snap-strictness)`,
          ]]);
        }
        ...
        n("scroll-auto", [["scroll-behavior", "auto"]]),
          ...
          n("hyphens-manual", [["-webkit-hyphens", "manual"], [
            "hyphens",
            "manual",
          ]]),
          ...
          n("break-normal", [["overflow-wrap", "normal"], [
            "word-break",
            "normal",
          ]]),
        ...
        n("border-solid", [["--tw-border-style", "solid"], [
          "border-style",
          "solid",
        ]]),
          n("border-dashed", [["--tw-border-style", "dashed"], [
            "border-style",
            "dashed",
          ]]),
          n("border-dotted", [["--tw-border-style", "dotted"], [
            "border-style",
            "dotted",
          ]]),
          n("border-double", [["--tw-border-style", "double"], [
            "border-style",
            "double",
          ]]),
          n("border-hidden", [["--tw-border-style", "hidden"], [
            "border-style",
            "hidden",
          ]]),
          n("border-none", [["--tw-border-style", "none"], [
            "border-style",
            "none",
          ]]);
        {
          let i = function (n, o) {
              t.functional(n, (t) => {
                ...
                if ("arbitrary" === t.value.kind) {
                  let r = t.value.value;
                  switch (
                    t.value.dataType ?? ie(r, ["color", "line-width", "length"])
                  ) {
                    case "line-width":
                    case "length": {
                      if (t.modifier) return;
          ...
          t.functional(n, (t) => {
            if (t.value) {
              if ("arbitrary" === t.value.kind) {
                let r = t.value.value;
                switch (
                  t.value.dataType ?? ie(r, ["color", "length", "percentage"])
                ) {
                  case "length":
                  case "percentage":
          ...
          t.functional(n, (t) => {
            if (t.value) {
              if ("arbitrary" === t.value.kind) {
                let r = t.value.value;
                switch (
                  t.value.dataType ?? ie(r, ["length", "percentage", "color"])
                ) {
                  case "color":
                    return r = Fe(r, t.modifier, e),
                      null === r ? void 0 : o.color(r);
        ...
        n("text-left", [["text-align", "left"]]),
          ...
          t.functional("font", (t) => {
            if (t.value && !t.modifier) {
              ...
              {
                let r = e.resolveWith(t.value.value, ["--font"], [
          ...
          });
        {
          ...
          t.functional("filter", (e) => {
            ...
            o("invert", {
              ...
              handle: (
                e,
              ) => [l(), x("--tw-invert", `invert(${e})`), x("filter", i)],
            }),
            o("backdrop-invert", {
            ...
            o("sepia", {
              ...
              handle: (
                e,
              ) => [l(), x("--tw-sepia", `sepia(${e})`), x("filter", i)],
            }),
            o("backdrop-sepia", {
            ...
            t.functional("drop-shadow", (t) => {
              let r;
              if (
                t.modifier && ("arbitrary" === t.modifier.kind
                  ? r = t.modifier.value
        ...
        }
        {
          ...
          n("transition-none", [["transition-property", "none"]]),
            n("transition-all", [["transition-property", "all"], [
            ...
            n("transition-opacity", [["transition-property", "opacity"], [
              "transition-timing-function",
              i,
            ], ["transition-duration", a]]),
            n("transition-shadow", [["transition-property", "box-shadow"], [
              "transition-timing-function",
              i,
            ], ["transition-duration", a]]),
        ...
        }
        {
          ...
          n("ease-initial", [e, ["--tw-ease", "initial"]]),
            n("ease-linear", [e, ["--tw-ease", "linear"], [
              "transition-timing-function",
              "linear",
            ]]),
            o("ease", {
        ...
        n("forced-color-adjust-none", [["forced-color-adjust", "none"]]),
          ...
          n("leading-none", [() => z([Ve("--tw-leading")]), [
            "--tw-leading",
            "1",
          ], ["line-height", "1"]]),
          a(
          ...
          n("antialiased", [["-webkit-font-smoothing", "antialiased"], [
            "-moz-osx-font-smoothing",
            "grayscale",
          ]]),
          n("subpixel-antialiased", [["-webkit-font-smoothing", "auto"], [
            "-moz-osx-font-smoothing",
            "auto",
          ]]);
        {
          ...
          n("normal-nums", [["font-variant-numeric", "normal"]]),
            ...
            n("diagonal-fractions", [t, [
              "--tw-numeric-fraction",
              "diagonal-fractions",
            ], ["font-variant-numeric", e]]),
            n("stacked-fractions", [t, [
              "--tw-numeric-fraction",
              "stacked-fractions",
            ], ["font-variant-numeric", e]]);
        }
        {
          ...
          t.static(
            ...
            n("outline-none", [["--tw-outline-style", "none"], [
              "outline-style",
              "none",
            ]]),
            n("outline-solid", [["--tw-outline-style", "solid"], [
              "outline-style",
              "solid",
            ]]),
            n("outline-dashed", [["--tw-outline-style", "dashed"], [
              "outline-style",
              "dashed",
            ]]),
            n("outline-dotted", [["--tw-outline-style", "dotted"], [
              "outline-style",
              "dotted",
            ]]),
            n("outline-double", [["--tw-outline-style", "double"], [
              "outline-style",
              "double",
            ]]),
            ...
            if (t.value) {
              if ("arbitrary" === t.value.kind) {
                ...
                switch (
                  ...
                  case "relative-size":
                    if (t.modifier) {
                      let n = "arbitrary" === t.modifier.kind
                        ? t.modifier.value
              ...
              {
                let r = e.resolveWith(t.value.value, ["--text"], [
                  "--line-height",
                  "--letter-spacing",
                  "--font-weight",
                ]);
                if (r) {
                  ...
                  if (t.modifier) {
                    let r = "arbitrary" === t.modifier.kind
                      ? t.modifier.value
                      : e.resolve(t.modifier.value, ["--leading"]);
          ...
          );
        {
              ...
              if ("arbitrary" === t.value.kind) {
                ...
                return "color" === (t.value.dataType ?? ie(n, ["color"]))
                  ? (n = Fe(n, t.modifier, e),
                    null === n ? void 0 : [
                      s(),
                      x("--tw-shadow-color", Ne(n, "var(--tw-shadow-alpha)")),
                    ])
                  : [
                    s(),
                    x("--tw-shadow-alpha", r),
              ...
              if ("arbitrary" === t.value.kind) {
                ...
                return "color" === (t.value.dataType ?? ie(n, ["color"]))
                  ...
                  : [
                    s(),
                    x("--tw-inset-shadow-alpha", r),
                    ...Me("--tw-inset-shadow", n, r, (e) =>
                      `var(--tw-inset-shadow-color, ${e})`, "inset "),
                    x("box-shadow", a),
                  ];
              }
              switch (t.value.value) {
              ...
              () => [
                {
                  values: ["current", "inherit", "transparent"],
                  valueThemeKeys: ["--box-shadow-color", "--color"],
                  modifiers: Array.from({ length: 21 }, (e, t) =>
                    "" + 5 * t),
                },
                { values: ["none"] },
                {
          ...
          t.functional("ring", (t) => {
            ...
            }
            {
              ...
              if (
                null === r && be(t.value.value) && (r = `${t.value.value}px`), r
              ) return [s(), x("--tw-ring-shadow", o(r)), x("box-shadow", a)];
            }
          }),
            r(
      ...
      r = function (e) {
        ...
        function a(e) {
          return e.includes("::")
            ? null
            : `&:not(${
              L(e, ",").map((e) => e.replaceAll("&", "*")).join(", ")
            })`;
        }
        t.compound("not", 3, (e, t) => {
          if (
            "arbitrary" === t.variant.kind && t.variant.relative || t.modifier
          ) return null;
          let r = !1;
          return C([e], (t, { path: n }) => {
            ...
            "rule" === e.kind && "&" === e.selector && 1 === e.nodes.length &&
      ...
      o = new u((e) =>
        Array.from(function* (e, t) {
          ...
          "!" === n[n.length - 1]
            ? (i = !0, n = n.slice(0, -1))
            : "!" === n[0] && (i = !0, n = n.slice(1)),
            t.utilities.has(n, "static") && !n.includes("[") &&
            (yield {
              kind: "static",
              root: n,
              variants: o,
                ...
                if (null !== r) {
                  {
                    ...
                    if (-1 !== e) {
                      ...
                      let e = null === l || "arbitrary" === n.modifier?.kind
                        ? null
                        : `${r}/${l}`;
      ...
      a = new u((e) =>
        new u((t) => {
          let r = function (e, t, r) {
            ...
            let o = t.important && !!(1 & r), a = [], l = `.${i(e.raw)}`;
            for (let r of n) {
              let n = at(r);
              (e.important || o) && it(r);
      ...
      s = {
        ...
        printCandidate: (e) =>
          function (e, t) {
            let r = [];
            for (let e of t.variants) r.unshift(P(e));
            ...
            return "arbitrary" === t.kind &&
              (n += `[${t.property}:${Z(t.value)}]`),
  ...
  function rt(e, t, { onInvalidCandidate: r, respectImportant: n } = {}) {
    ...
    return i.sort((e, t) => {
      ...
      for (
        ;
        i < r.properties.order.length && i < n.properties.order.length &&
        r.properties.order[i] === n.properties.order[i];
      ) i += 1;
      return (r.properties.order[i] ?? 1 / 0) -
          (n.properties.order[i] ?? 1 / 0) ||
        n.properties.count - r.properties.count || Pe(r.candidate, n.candidate);
    }),
  ...
  function nt(e, t, r, n = 0) {
    ...
    if ("compound" === t.kind) {
      ...
      return C(i.nodes, (t) => {
        if (
          ("rule" === t.kind || "at-rule" === t.kind) && t.nodes.length <= 0
    ...
    function d(e, r = []) {
      if (!l.has(e)) {
        if (c.has(e)) {
          ...
          throw "at-rule" === e.kind && "@utility" === e.name &&
            "at-rule" === n.kind && "@utility" === n.name && C(e.nodes, (e) => {
                ...
                if (r.length > 1) {
                  ...
                  if (t.candidatesToCss([n])[0]) {
                    ...
                    if (o.length > 0) {
                      if (1 === o.length) {
                        throw new Error(
                          `Cannot apply utility class \`${e}\` because the ${
                            o.map((e) => `\`${e}\``)
        ...
        let c = function (e) {
          ...
          for (let i = 0; i < e.length; i++) {
            ...
            if ("separator" !== a.kind) {
              ...
              if (
                "function" === a.kind && "url" === a.value.toLowerCase() || !t
              ) return null;
              if (
              ...
              if (
                "function" === a.kind && "supports" === a.value.toLowerCase()
              ) {
                if (o) return null;
                o = m(a.nodes);
                continue;
  ...
  function ut(e, t = null) {
    return Array.isArray(e) && 2 === e.length && "object" == typeof e[1] &&
        null !== typeof e[1]
      ? t ? e[1][t] ?? null : e[0]
  ...
  function dt(e, { theme: t }, r) {
          ...
          if (
            function (e) {
              if (
                ...
                void 0 === e[1] || null === e[1] || "object" != typeof e[1]
              ) return !1;
    ...
    if (Object.hasOwn(t, "fontFamily")) {
      let r = 5;
      {
        ...
        n && e.theme.hasDefault("--font-sans") &&
      ...
      }
      {
        ...
        n && e.theme.hasDefault("--font-mono") &&
  ...
  function pt(e) {
    ...
    return e.map((e, t, r) => "1" === e && t !== r.length - 1 ? "" : e).map(
      (e) =>
        e.replaceAll(".", "_").replace(
          /([a-z])([A-Z])/g,
          (e, t, r) => `${t}-${r.toLowerCase()}`,
        ),
    ).filter((t, r) => "DEFAULT" !== t || r !== e.length - 1).join("-");
  }
  function ht(e, t = [], r) {
    ...
    for (let a = 0; a < e.length; a++) {
      ...
      switch (l) {
        ...
        case 40: {
          ...
          if (
            i = "",
              ":not" !== l.value && ":where" !== l.value &&
              ":has" !== l.value && ":is" !== l.value
          ) {
            let n = a + 1, s = 0;
            for (let r = a + 1; r < e.length; r++) {
  ...
  function Kt(
    ...
    let a = {
      ...
      addVariant(t, r) {
        ...
        if ("string" == typeof r) { if (r.includes(":merge(")) return; }
      ...
      matchVariant(t, r, n) {
        ...
        e.variants.group(() => {
          ...
          if (n && "function" == typeof n.sort) {
            return n.sort({ value: a, modifier: e.modifier?.value ?? null }, {
              value: l,
      ...
      addUtilities(r) {
        let a = (r = Array.isArray(r) ? r : [r]).flatMap(
          (e) => Object.entries(e),
        );
      ...
      matchUtilities(t, r) {
        ...
        for (let [i, a] of Object.entries(t)) {
          let t = function ({ negative: t }) {
            return (l) => {
              if (
                "arbitrary" === l.value?.kind && o.length > 0 &&
                !o.includes("any") &&
                    ...
                    ? "arbitrary" === l.value.kind
                      ...
                      : e.__BARE_VALUE__ &&
                        (u = e.__BARE_VALUE__(l.value) ?? null,
                          d = (null !== l.value.fraction && u?.includes("/")) ??
                            !1)
                    : u = e.DEFAULT ?? null;
              }
              if (null === u) return;
  ...
  var Ut = Wt((e) => {
    ...
    Rt = {
      ...
      backdropBrightness: ({ theme: e }) => ({ ...e("brightness"), ..._t }),
      backdropContrast: ({ theme: e }) => ({ ...e("contrast"), ..._t }),
      backdropGrayscale: ({ theme: e }) => ({ ...e("grayscale"), ..._t }),
      backdropHueRotate: ({ theme: e }) => ({ ...e("hueRotate"), ...Bt }),
      backdropInvert: ({ theme: e }) => ({ ...e("invert"), ..._t }),
      backdropOpacity: ({ theme: e }) => ({ ...e("opacity"), ..._t }),
      backdropSaturate: ({ theme: e }) => ({ ...e("saturate"), ..._t }),
      backdropSepia: ({ theme: e }) => ({ ...e("sepia"), ..._t }),
      ...
      divideWidth: ({ theme: e }) => ({ ...e("borderWidth"), ...Dt }),
      dropShadow: {
      ...
      outlineWidth: { 0: "0px", 1: "1px", 2: "2px", 4: "4px", 8: "8px", ...Dt },
      ...
      saturate: { 0: "0", 50: ".5", 100: "1", 150: "1.5", 200: "2", ..._t },
      scale: {
        0: "0",
        50: ".5",
        75: ".75",
  ...
  function Ht(e, t) {
    ...
    for (let e of r.configs) {
      "darkMode" in e && void 0 !== e.darkMode &&
      (r.result.darkMode = e.darkMode ?? null),
        "prefix" in e && void 0 !== e.prefix &&
        (r.result.prefix = e.prefix ?? ""),
        "blocklist" in e && void 0 !== e.blocklist &&
        (r.result.blocklist = e.blocklist ?? []),
        "important" in e && void 0 !== e.important &&
  ...
  function Yt(e, { config: t, base: r, path: n, reference: o, src: i }) {
    ...
    let l = t.content ?? [], s = Array.isArray(l) ? l : l.files;
    for (let t of s) {
  ...
  function Gt(e, t) {
    ...
    let n = function ({ center: e, padding: t, screens: r }, n) {
      ...
      if ("object" == typeof t && null !== t) {
        let e = Object.entries(t).filter(([e]) => "DEFAULT" !== e).map(
          ([e, t]) => [e, n.theme.resolveValue(e, ["--breakpoint"]), t],
        ).filter(Boolean);
    ...
    if ("variant" === n) {
      ...
      if (
        Array.isArray(o) || "function" == typeof o
          ? e = o
          : "string" == typeof o && (e = [o]), Array.isArray(e)
      ) {
        for (let t of e) {
          ".dark" === t
            ? (n = !1,
  ...
  var Qt = /^[a-z]+$/;
  async function er(
    { designSystem: e, base: t, ast: r, loadModule: n, sources: o },
  ) {
    let i = 0, a = [], l = [];
        ...
        if ("@plugin" === e.name) {
          ...
          for (let t of e.nodes ?? []) {
            ...
            let e = L(t.value, ",").map((e) => {
              ...
              if ("{" === e[0] && "}" === e[e.length - 1]) {
                throw new Error(
                  `Unexpected \`@plugin\` option: Value of declaration \`${
                    S([t]).trim()
    ...
    let [c, u] = await Promise.all([
      Promise.all(l.map(async ({ id: e, base: t, reference: r, src: o }) => {
  ...
  function tr(
    ...
    if (
      dt(e, c, u),
        ...
        function (e, t) {
          ...
          if (0 !== o.length) {
            for (let [, e] of t.variants.variants) {e.order > n &&
                (e.order += o.length);}
    ...
    if (
      ...
      C(r, (t, { replaceWith: r, parent: n }) => {
        if (
          "at-rule" === t.kind && "@tailwind" === t.name &&
          "utilities" === t.params
      ...
      if ("at-rule" === e.kind) {
        ...
        if (
          ...
          (null === t
            ...
            : w.push(e)), "@custom-variant" === e.name
        ) {
          if (null !== t) {
          ...
          if (!Ye.test(n)) {
            throw new Error(
              `\`@custom-variant ${n}\` defines an invalid variant name. Variants should only contain alphanumeric, dashes, or underscore characters and start with a lowercase letter or number.`,
            );
          }
          ...
          for (let r of t) {
            if (r.startsWith("source(")) {
              ...
              C(e.nodes, (e, { replaceWith: r }) => {
                if (
                  "at-rule" === e.kind && "@tailwind" === e.name &&
                  "utilities" === e.params
                ) {
          ...
          let [t, o] = function (e) {
            ...
            for (let n of L(e, " ")) {
              "reference" === n
                ...
                : "static" === n
                ? t |= 8
                : n.startsWith("prefix(") && n.endsWith(")") &&
                  (r = n.slice(7, -1));
            }
            return [t, r];
          }(e.params);
  ...
  async function kr(e, t) {
    try {
      let r = function () {
        ...
        if (
          "tailwindcss/preflight" === e || "tailwindcss/preflight.css" === e ||
          "./preflight.css" === e
        ) {
          return {
        ...
        if (
          "tailwindcss/theme" === e || "tailwindcss/theme.css" === e ||
          "./theme.css" === e
        ) {
          return {
        ...
        if (
          "tailwindcss/utilities" === e || "tailwindcss/utilities.css" === e ||
          "./utilities.css" === e
        ) {
          return {
  ...
  new MutationObserver((e) => {
    ...
    for (let n of e) {
      for (let e of n.addedNodes) {
        e.nodeType === Node.ELEMENT_NODE && "STYLE" === e.tagName &&
          e.getAttribute("type") === fr && ($r(e), t++);
      }
